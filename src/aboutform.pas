...
begin
  ...
  bounds_cymax := round(350 * ratio);
  bounds_cymin := bounds_cymax;
  font.Height  := fonth;

  about_text.font.color  := font.color;
  about_text.font.Height := font.Height;
  about_text.left        := round(10 * ratio);
  about_text.Width       := round(352 * ratio);
  about_text.Height      := round(330 * ratio);
  about_text.top         := round(10 * ratio);
 end;
